<div id='centeredFormModal' class="modal-wrapper">
    ...
    <div class="modal modal-centered">
        <div class="modal-content shadow-lg p-5">
            ...
            <!-- Modal content -->
            <form id='form_id' class="w-full" action="{{ route('fournisseurs.store') }}" method="POST">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            id="grid-last-name" type="text" name="nom_fournisseur_FOURNISSEURS" >
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-light mb-1"
                            for="grid-last-name">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                            id="grid-last-name" type="text" name="prenom_fournisseur_FOURNISSEURS">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                            id="grid-last-name" type="text" name="adresse_fournisseur_FOURNISSEURS" >
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-light mb-1"
                            for="grid-last-name">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-grey-darker border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                            id="grid-last-name" type="text" name="email_fournisseur_FOURNISSEURS">
                    </div>
                </div>
